                        ...
                        <ul id="product" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li class="">
                                <a href="{{route('hotels.index')}}">
                                    <i class="las la-minus"></i><span>List Hotel</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="{{route('hotels.create')}}">
                                    <i class="las la-minus"></i><span>Add Hotel</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                          ...
                          <ul id="sale" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="">
                                          <a href="../backend/page-list-sale.html">
                                              <i class="las la-minus"></i><span>List Room Booking</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          ...
                                          <div class="card-body p-0 text-center">
                                              ...
                                              <div class="p-3">
                                                  ...
                                                  <div class="d-flex align-items-center justify-content-center mt-3">
                                                      <a href="{{ route('profile.update') }}" class="btn border mr-2">Profile</a>
